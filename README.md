...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0a0a0a,40:1a0505,100:e63946&height=240&section=header&text=ODZIGON&fontColor=fdfdfd&fontSize=80&fontAlignY=35&desc=Developer%20%C2%B7%20Data%20Analyst%20%C2%B7%20Cybersecurity&descAlignY=57&descSize=18&animation=fadeIn" width="100%"/>

<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=23&pause=1200&color=E63946&center=true&vCenter=true&width=680&height=48&lines=Code%2C+analyze%2C+learn%2C+repeat.;Turning+raw+data+into+insight.;Securing+systems%2C+one+pattern+at+a+time.;Co-founder+of+the+NEXIUM+collective." alt="Typing SVG"/>
...
class Odzigon:
    def __init__(self):
        self.role       = ["Developer", "Data Analyst"]
        self.field      = "Cybersecurity"
        self.collective = "NEXIUM"           # co-founder
        self.focus      = ["data visualization", "analytics", "security insights"]
        self.learning   = ["Lua", "SQL"]
        self.mindset    = "Code, analyze, learn, repeat."

    def current_status(self) -> str:
        return "Analyzing data · Finding patterns · Securing systems"
```
...
I work as a **Data Analyst** inside a **Cybersecurity company** — turning raw data into actionable defense. My day-to-day revolves around spotting anomalies, mapping patterns across noisy datasets, and translating findings into clear visual intelligence that helps secure real systems. Outside of work, I co-founded **[NEXIUM](https://github.com/odzigon)** — an independent collective building applications, Discord clients, games and OSINT tooling.
...
Making complex signal readable at a glance
...
Pattern detection · trend analysis · anomaly hunting
...
Threat surfacing & data-driven hardening
...
<img src="https://streak-stats.demolab.com/?user=odzigon&hide_border=true&background=0a0a0a&ring=e63946&fire=e63946&currStreakLabel=fdfdfd&sideLabels=fdfdfd&dates=8b8b8b&stroke=1a0505&currStreakNum=fdfdfd&sideNums=fdfdfd"/>
